...
public class BookingView extends JFrame {
	...
	private void initComponents() {
		...
		txtCheckInDate.getCalendarButton()
				.setIcon(new ImageIcon(BookingView.class.getResource("/images/icon-reservas.png")));
		...
		editor_2.setBackground(Color.WHITE);
		editor_2.setDisabledTextColor(SystemColor.textHighlight);
		txtCheckOutDate.getCalendarButton()
				.setIcon(new ImageIcon(BookingView.class.getResource("/images/icon-reservas.png")));
		...
		txtCheckOutDate.setBorder(new LineBorder(Color.WHITE, 0));
		...
		lblPrice.setBounds(72, 303, 219, 14);
		...
		txtPaymentMethod.setBorder(new LineBorder(Color.WHITE, 1, true));
		...
		lblTitle.setBounds(95, 62, 237, 42);
